...
３日ほど調べただけで、下記のようなことができるようになりました。<br>
ただ、0からコードを書いていたわけではないので、<br>
これからもっと勉強して、0からコードを書ける人になっていきたいです。<br>
...
●作成した成果物をGitHub上にアップロード<br>
※無料で行いたかったので、「rendor」を利用しました。
・そもそもほかの方に見てもらうためにはWebサイトにアップロードする必要がある<br>
・GitHubのみでは、ソースコードが確認出来るのみ<br>
・GitHubと連携出来る「rendor」は、コストがかからずとても有用<br>
